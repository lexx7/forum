...
package com.example.forum.security.util;
...
public final class SecurityUtils {
    ...
    public static long getCurrentUserId() {
        ...
        if (currentUser instanceof PermissionUserDetails) {
            return ((PermissionUserDetails) currentUser).getUserId();
        }
    ...
    public static boolean hasPermission(Permission permission) {
        ...
        if (permission != null && authentication != null) {
            Object principal = authentication.getPrincipal();
            if (principal instanceof PermissionUserDetails) {
                return
                        ((PermissionUserDetails) principal)
                                .getPermissions()
                                .contains(permission);
            }
        }
